...
procedure Register;
begin
  RegisterComponents('Data Access', [TDataListBox]);
end;

procedure TDataListBox.init;
var
  field: TField;
begin
  self.Items.Clear;
...
procedure TDataListBox.init(lDataSet: TDataSet; lDataFieldName: string);
begin
...
// Create a ListView
constructor TDataListBox.Create(AOwner: TComponent);
begin
